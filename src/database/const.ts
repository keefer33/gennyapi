...
export const PLAYGROUND_LIST_SELECT =
  ...
  'id, created_at, user_id, gen_model_id, status, task_id, cost, duration, generation_type, gen_models:gen_models!gen_model_id(model_name, model_id, brand_name, model_product, model_variant), user_files!gen_model_run_id(id, file_name, thumbnail_url, file_path, file_type, created_at, status), payload, response, polling_response';

export const RUN_AGENT_SELECT =
  'id, created_at, status, cost, duration, generation_type, gen_models:gen_models!gen_model_id(model_name, model_id, brand_name, model_product, model_variant), user_files!gen_model_run_id(id, file_name, thumbnail_url, file_path, file_type, created_at, status), payload, response, polling_response';
